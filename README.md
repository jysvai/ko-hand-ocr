...
| **꾸러미** | 83KB — 코드만 |
| **속도** | **줄당 0.20초** · 사진 한 장 1.35초 — **GPU 없이 CPU 만으로** |
...
| 받는 것 | 크기 | 무엇 |
|---|---|---|
| `ko-hand-ocr-v62.zip` | 128MB | **판 하나.** 대부분 이것으로 충분하다. 줄당 0.20초 |
...
|---|---|---|---|---|---|
| 판 하나, 빔 5 | 0.72초 | 0.63초 | 1.35초 | 0.20초 | 6.7초 |
| 판 하나, 그리디 | 0.73초 | 0.34초 | 1.07초 | 0.11초 | 3.9초 |
| 판 셋, 빔 5 | 0.74초 | 5.31초 | 6.04초 | 1.67초 | 50.8초 |

메모리는 판 하나 약 905MB, 판 셋 약 1.18GB.
...
넘었다. 층을 늘려도 CPU 속도는 줄당 0.16초에서 0.20초로만 내려간다 — 인코더와
입력 크기는 건드리지 않았다.
